...
{   
    ...
    DsDpi_triangle triangle(&kDsDpi, &Y_meson);
    ...
    {
        double sigma = w * w;
        return triangle.dGamma_ab(s, sigma);
    };
    ...
    filename = "triangle_width_ab.pdf";

    triangle.set_debug(0); triangle.normalize(1., s);
    plotter->AddEntry(N, dgammaab, {xmin, xmax}, "S and D waves", PRINT);
    triangle.set_debug(1); triangle.normalize(1., s);
    ...
    {
        double sigma = w * w;
        return triangle.dGamma_bc(s, sigma);
    };
    ...
    filename = "triangle_width_bc.pdf";
    ...
    {
        double sigma = w * w;
        return triangle.dGamma_ac(s, sigma);
    };
    ...
    filename = "triangle_width_ac.pdf";
